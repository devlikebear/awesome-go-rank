...
|------------|-------|-------|--------------|-------------|
| [go-git/go-git](https://github.com/go-git/go-git) | 7k | 804 | 2025-07-08T19:36:27Z |  highly extensible Git implementation in pure Go. |
...
| [jfrog/froggit-go](https://github.com/jfrog/froggit-go) | 47 | 21 | 2025-06-24T12:15:06Z |  Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
