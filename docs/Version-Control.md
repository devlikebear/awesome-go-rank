...
|------------|-------|-------|--------------|-------------|
| [go-git/go-git](https://github.com/go-git/go-git) | 7k | 809 | 2025-07-18T18:02:07Z |  highly extensible Git implementation in pure Go. |
...
| [jfrog/froggit-go](https://github.com/jfrog/froggit-go) | 47 | 23 | 2025-07-17T09:32:44Z |  Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
