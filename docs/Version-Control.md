...
|------------|-------|-------|--------------|-------------|
| [go-git/go-git](https://github.com/go-git/go-git) | 7k | 806 | 2025-07-10T14:25:22Z |  highly extensible Git implementation in pure Go. |
...
| [jfrog/froggit-go](https://github.com/jfrog/froggit-go) | 47 | 21 | 2025-07-09T06:40:04Z |  Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
