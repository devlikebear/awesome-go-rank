...
|------------|-------|-------|--------------|-------------|
| [adnanh/webhook](https://github.com/adnanh/webhook) | 12k | 867 | 2026-05-08T18:17:08Z |  Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
