...
|------------|-------|-------|--------------|-------------|
| [FiloSottile/age](https://github.com/FiloSottile/age) | 23k | 648 | 2026-06-18T23:43:28Z |  A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [go-acme/lego](https://github.com/go-acme/lego) | 10k | 1k | 2026-06-18T17:36:41Z |  Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [Ullaakut/cameradar](https://github.com/Ullaakut/cameradar) | 5k | 622 | 2026-06-18T19:09:20Z |  Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [djadmin/fort](https://github.com/djadmin/fort) | 24 | 1 | 2026-06-18T07:56:49Z |  Audits macOS security settings across 16 checks, reports a score, and fixes issues where it safely can. Single binary, installable via Homebrew. |
